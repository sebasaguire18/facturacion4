<?php
	...
	if($datos_venta->rowCount()==1){
		...
		$pdf = new PDF_Code128('P','mm',array(80,290));
		$pdf->AliasNbPages();
		$pdf->SetMargins(4,10,4);
        $pdf->AddPage();
		// $pdf->Image(APP_URL.'app/views/img/logo.png',23,5,35,35,'PNG');
        // $pdf->Ln(30);
        ...
        $pdf->Ln(4);
        $pdf->SetFont('Arial','',9);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1",'Hector Arango'),0,'C',false);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1",'NIT: 1014261481'),0,'C',false);
		$pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Régimen Persona Natural"),0,'C',false);
        ...
        $pdf->MultiCell(0,6,iconv("UTF-8", "ISO-8859-1",'Sistema POS'),0,'C',false);
        $pdf->SetFont('Arial','B',10);
        ...
        $pdf->Cell(32,5,iconv("UTF-8", "ISO-8859-1",$datos_venta['forma_pago']),0,0,'C');
        $pdf->SetFont('Arial','',9);
        ...
        $pdf->Cell(32,5,iconv("UTF-8", "ISO-8859-1",MONEDA_SIMBOLO.number_format($datos_venta['venta_descuento'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),0,0,'C');
        ...
        $pdf->Ln(6);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","*** GARANTÍA Y DEVOLUCIÓN***"),0,'C',false);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","*** CONTROL Y CALIDAD***"),0,'C',false);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","° 2 meses de garantía por costura y despegue. "),0,'C',false);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","° Después de la revisión del teni, 3 días hábiles para respuesta."),0,'C',false);
        $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","° Mal uso o mal lavado no tiene garantía."),0,'C',false);
