<?php
	...
	class clientController extends mainModel{
		...
		public function registrarClienteControlador(){
			...
			if (isset($_POST['cliente_tipo_cliente'])) {
				$tipo_cliente=$this->limpiarCadena($_POST['cliente_tipo_cliente']);
			}else {
				$tipo_cliente='Comun';
			}
            ...
            if($numero_documento=="" || $nombre=="" || $apellido=="" || $provincia=="" || $ciudad=="" || $direccion=="" || $tipo_cliente==""){
            	$alerta=[
					"tipo"=>"simple",
		    ...
		    $cliente_datos_reg=[
				...
				[
					"campo_nombre"=>"cliente_tipo_cliente",
					"campo_marcador"=>":Tipo",
					...
					foreach($datos as $rows){
						$tabla.='
							<tr class="has-text-centered" >
								...
								<td>'.$rows['cliente_tipo_cliente'].'</td>
								<td>
