...
<div class="container pb-6 pt-2">
    ...
    ?>
    <div class="columns pb-6 pl-5">
        <div class="content">
            <div class="rw" id="listarProductosRapidos">
                <!-- <button onclick="listar_productosRapidos()">Traer Productos</button> -->
            </div>
        </div>
    </div>
    <div class="columns">
        
        <div class="column pb-6 pl-5">
                        ...
                        <tr class="has-text-centered" >
                            ...
                            <td>
                                <?php   if ($_SESSION['usuario']=='Administrador') { ?>
                                    <div class="control">
                                        <input class="input sale_input-price has-text-centered" value="<?php echo $productos['venta_detalle_precio_venta']; ?>" id="sale_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>_v" type="text" style="max-width: 100px;">
                                    </div>
                                <?php   }elseif($_SESSION['usuario']<>'Administrador'){ 

                                    echo MONEDA_SIMBOLO.number_format($productos['venta_detalle_precio_venta'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".MONEDA_NOMBRE;
                            ...
                            <td>
                                <button type="button" class="button is-success is-rounded is-small" onclick="actualizar_cantidad('#sale_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>','<?php echo $productos['producto_codigo']; ?>','#sale_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>_v')" >
        ...
        <div class="column is-one-quarter">
            ...
            <?php } ?>
                ...
                <label>Forma de pago <?php echo CAMPO_OBLIGATORIO; ?></label><br>
                <div class="select mb-5">
                    <select name="forma_pago">
                        <?php
                            echo $insLogin->generarSelect(FORMA_PAGO,"VACIO");
                        ?>
                    </select>
                </div>
                <br>
                ...
                ?>
                    <div class="control mb-5">
                        ...
                        <input class="input" type="text" name="venta_descuento" id="venta_descuento" value="0.00" pattern="[0-9.]{1,25}" maxlength="25" >
                    </div>
                <?php   }elseif($_SESSION['usuario']<>'Administrador'){ ?>  
                    <div class="control mb-5">
                        <label>Descuento</label>
                        <input class="input" type="text" name="venta_descuento" id="venta_descuento" value="0.00" readonly >
                    </div>
                <?php   } ?>
                <div class="control mb-5">
...
<script>
    ...
    /*----------  Buscar codigo  ----------*/
    function listar_productosRapidos(){
        
        let datos = new FormData();
        datos.append("mostrar_productos", '');
        datos.append("modulo_venta", "mostrar_productos");
        ...
        .then(respuesta =>{
            let listar_productos=document.querySelector('#listarProductosRapidos');
            listar_productos.innerHTML=respuesta;
        });
    }
    listar_productosRapidos();
    ...
    function actualizar_cantidad(id,codigo,id_v){
        let cantidad=document.querySelector(id).value;
        let precio=document.querySelector(id_v).value;
        ...
        if(cantidad>0){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed){
                    ...
                    datos.append("producto_precio", precio);
    ...
    let venta_descuento_input = document.querySelector("#venta_descuento");
    venta_descuento_input.addEventListener('keyup', function(e){
        e.preventDefault();
